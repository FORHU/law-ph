      ...
      {tabConfig.map((tab) => {
        ...
        return (
          <button
            ...
            className={`px-3 py-1.5 rounded-md flex items-center justify-center gap-1.5 text-xs font-semibold whitespace-nowrap transition-all flex-1 md:flex-none ${isActive

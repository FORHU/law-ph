...
Notes/Transcript: ${activeCase.notes || "None provided"}`;
  ...
  const handleDocumentAnalyzed = (data: any) => {
    ...
    const prompt = isPreAnalyzed
      ? `[ILM_META]${metaStr}[/ILM_META]ANALYZING\n\n[HIDDEN_INSTRUCTION]I have uploaded a legal document titled "${filename}". Here is the initial AI analysis:\n\n${content}\n\n---\n\nBased on this analysis, please provide:\n1. **Additional Insights** ΓÇö anything important the analysis may have missed or should expand on.\n2. **Practical Recommendations** ΓÇö specific, actionable steps I or my client should take immediately.\n3. **Key Risk Flags** ΓÇö the top 3 most critical legal risks in this document and how to mitigate them.\n4. **Suggested Follow-up Questions** ΓÇö questions I should be asking a lawyer or the other party regarding this document.\n5. **Next Steps** ΓÇö a prioritized action plan (e.g., what to sign, register, negotiate, or dispute).[/HIDDEN_INSTRUCTION]`
